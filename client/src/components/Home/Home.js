...
return ( <>
    ...
    <h3> find ip, location and mobile details of scammer </h3>
    ...
    <h2 className="section_title"> Way 's to find ip,location and mobile details of scammer</h2>
    <section className="section1_container">
    <div className="section_container-img">
    <img src={ image1 } className="section_img" />
    </div>

    <div className="section1_container-text">
    <h3 className="section_text"> 1. send any url or link to image and track the scammer </h3>
    </div>
    </section>

    <section className="section2_container">
    <div className="section2_container-text">
    <h3 className="section_text"> 2. send the error page and track the scammer </h3>
    </div>

    <div className="section_container-img">
    <img src={ image2 } className="section_img" alt="hero"/>
    </div>
    </section>
    </section>
    <Footer/>
